...
<body>
   ...
   <audio id="linkmp3">https://raw.githubusercontent.com/wclasher/Public/refs/heads/main/ssstik.io_1758642496246.mp3</audio>
   
   <div id="bodyblur">
     <img src="https://raw.githubusercontent.com/wclasher/Public/refs/heads/main/1758642018411.jpg" id="wallpaper"/>
   </div>
   ...
   <div id='Content'>
     ...
     <div><blockquote id='bq'>
       ...
       <p id="kalimat">Kamu Mau Gak<br>Jadi Pacar Aku? 🤭❤️<br><span id="pesanTolak" style="opacity:0;font-size: 15px;font-weight: 400;transform:scale(0);transition: all .6s ease;position: absolute;display: flex;justify-content: center;">Harus mau dong! 😝</span></p>
       <p id="kalimatb"></p>
       <p id="kalimatc"></p>
  ...
  <script>
  ftom=0;ftganti=0;fungsi=0;Bn2.innerHTML=Bn.innerHTML;kalimat2b.style="display:none";
  function showDiv() {pesanwhatsapp = "Aku mau kok jadi pacarmu ><";Bn2.style.display="none";Content.style = "opacity:1;margin-top:10vh;";ket.style="margin-top:30px";}
  ...
  async function menuju(){await swals.fire('OK!', 'Kirim pesan ke WhatsApp aku, ya!', 'success');window.location = "https://api.whatsapp.com/send/?phone=6285398663286&text=" + pesanwhatsapp;Tombol.style="margin-top:15px;opacity:1;transform: scale(1);";} setTimeout(showDiv,100);
